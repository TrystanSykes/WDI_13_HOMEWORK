...
heroes_starting_with_b = heroes.select { |hero| hero[0] =~ /b/i}
# Hashes
...
ninja_key_array = ninja_turtle.collect {|key,value| key }

# ninja_key_array = ninja_turtle.keys works too
# Bonus
